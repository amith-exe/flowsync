...
- `usage.md` — common workflows, examples, and how to inspect journals and checkpoint logs.
- `cli-reference.md` — summaries of main commands and flags.
- `architecture.md` — high-level design and component responsibilities.
- `development.md` — how to build, run tests, and contribute.
- `CONTRIBUTING.md` — contribution guidelines and coding standards.

Pick a page to start with or run the Quickstart to get a live demo site.
